...
If it's not clear what the fix is, come up with a few possible theories, and a plan for how the
user can test them and report back. You can help the user think of ways to reproduce the bug,
write a simple test case to expose the bug, or other debugging techniques.
